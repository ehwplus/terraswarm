...
| Name | Source | Version |
|------|--------|---------|
| <a name="module_loki_docker_service"></a> [loki\_docker\_service](#module\_loki\_docker\_service) | github.com/ehwplus/terraswarm//modules/base_docker_service | main |
| <a name="module_loki_docker_volume"></a> [loki\_docker\_volume](#module\_loki\_docker\_volume) | github.com/ehwplus/terraswarm//modules/base_docker_volume | main |
...
| <a name="input_loki_config"></a> [loki\_config](#input\_loki\_config) | The static config file for Loki | `string` | `null` | no |
| <a name="input_loki_service_port"></a> [loki\_service\_port](#input\_loki\_service\_port) | The internal and external service port for Loki | `number` | `3100` | no |
...
| Name | Description |
|------|-------------|
| <a name="output_this"></a> [this](#output\_this) | The Loki docker service. |
<!-- END_TF_DOCS -->
