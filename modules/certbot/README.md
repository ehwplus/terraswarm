...
| Name | Source | Version |
|------|--------|---------|
| <a name="module_certbot_docker_service"></a> [certbot\_docker\_service](#module\_certbot\_docker\_service) | github.com/ehwplus/terraswarm//modules/base_docker_service | main |
| <a name="module_certbot_docker_volume"></a> [certbot\_docker\_volume](#module\_certbot\_docker\_volume) | github.com/ehwplus/terraswarm//modules/base_docker_volume | main |
...
| <a name="input_certbot_standalone"></a> [certbot\_standalone](#input\_certbot\_standalone) | Whether certbot runs standalone and shall open port 80 and 443 by default. | `bool` | `true` | no |
...
| Name | Description |
|------|-------------|
| <a name="output_this"></a> [this](#output\_this) | The certbot docker service. |
<!-- END_TF_DOCS -->
