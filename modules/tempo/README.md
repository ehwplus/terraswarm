...
| Name | Source | Version |
|------|--------|---------|
| <a name="module_tempo_service"></a> [tempo\_service](#module\_tempo\_service) | github.com/ehwplus/terraswarm//modules/base_docker_service | main |
...
| <a name="input_tempo_config"></a> [tempo\_config](#input\_tempo\_config) | Tempo configuration file contents. | `string` | `null` | no |
| <a name="input_tempo_service_port"></a> [tempo\_service\_port](#input\_tempo\_service\_port) | Port to expose the tempo service on. | `number` | `3200` | no |

## Outputs

| Name | Description |
|------|-------------|
| <a name="output_this"></a> [this](#output\_this) | The tempo docker service. |
<!-- END_TF_DOCS -->
