...
| Name | Source | Version |
|------|--------|---------|
| <a name="module_pgadmin_docker_service"></a> [pgadmin\_docker\_service](#module\_pgadmin\_docker\_service) | github.com/ehwplus/terraswarm//modules/base_docker_service | main |
...
| <a name="input_service_port"></a> [service\_port](#input\_service\_port) | The external service port for PgAdmin | `number` | `80` | no |
