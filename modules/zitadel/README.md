...
| <a name="input_postgresql_constraints"></a> [postgresql\_constraints](#input\_postgresql\_constraints) | (Optional) The container placement constraints specific to the PostgreSQL service. | `set(string)` | `[]` | no |
| <a name="input_postgresql_limit"></a> [postgresql\_limit](#input\_postgresql\_limit) | (Optional) The resource limit of the PostgreSQL service, memory unit is MB. | <pre>object({<br>    cores  = optional(number)<br>    memory = optional(number)<br>  })</pre> | `null` | no |
| <a name="input_postgresql_reservation"></a> [postgresql\_reservation](#input\_postgresql\_reservation) | (Optional) The resource reservation for the PostgreSQL service, memory unit is MB. | <pre>object({<br>    cores  = optional(number)<br>    memory = optional(number)<br>    generic_resources = optional(object({<br>      discrete_resources_spec = optional(set(string))<br>      named_resources_spec    = optional(set(string))<br>    }))<br>  })</pre> | `null` | no |
...
| <a name="input_zitadel_constraints"></a> [zitadel\_constraints](#input\_zitadel\_constraints) | (Optional) The container placement constraints specific to the Zitadel service. | `set(string)` | `[]` | no |
...
| <a name="input_zitadel_limit"></a> [zitadel\_limit](#input\_zitadel\_limit) | (Optional) The resource limit of the Zitadel service, memory unit is MB. | <pre>object({<br>    cores  = optional(number)<br>    memory = optional(number)<br>  })</pre> | `null` | no |
| <a name="input_zitadel_reservation"></a> [zitadel\_reservation](#input\_zitadel\_reservation) | (Optional) The resource reservation for the Zitadel service, memory unit is MB. | <pre>object({<br>    cores  = optional(number)<br>    memory = optional(number)<br>    generic_resources = optional(object({<br>      discrete_resources_spec = optional(set(string))<br>      named_resources_spec    = optional(set(string))<br>    }))<br>  })</pre> | `null` | no |
