...
| <a name="input_zitadel_default_config"></a> [zitadel\_default\_config](#input\_zitadel\_default\_config) | The default configuration for Zitadel | `string` | n/a | yes |
| <a name="input_zitadel_internal_port"></a> [zitadel\_internal\_port](#input\_zitadel\_internal\_port) | The zitadel internal port. Make sure to have this in sync with your custom config if set. | `string` | `8080` | no |
| <a name="input_zitadel_step_config"></a> [zitadel\_step\_config](#input\_zitadel\_step\_config) | A step configuration for Zitadel | `string` | n/a | yes |
