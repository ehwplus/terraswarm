...
| <a name="input_redis_volume_options"></a> [redis\_volume\_options](#input\_redis\_volume\_options) | The redis volume driver with its options. | <pre>object({<br>    driver         = optional(string, "local")<br>    driver_options = optional(map(string), {})<br>  })</pre> | `{}` | no |
