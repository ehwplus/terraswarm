...
| Name | Source | Version |
|------|--------|---------|
| <a name="module_prometheus_docker_volume"></a> [prometheus\_docker\_volume](#module\_prometheus\_docker\_volume) | github.com/ehwplus/terraswarm//modules/base_docker_volume | main |
| <a name="module_prometheus_service"></a> [prometheus\_service](#module\_prometheus\_service) | github.com/ehwplus/terraswarm//modules/base_docker_service | main |
...
| <a name="input_prometheus_config"></a> [prometheus\_config](#input\_prometheus\_config) | The static config file for Prometheus | `string` | `null` | no |
| <a name="input_prometheus_service_port"></a> [prometheus\_service\_port](#input\_prometheus\_service\_port) | The internal and external service port for Prometheus | `number` | `9090` | no |
...
| Name | Description |
|------|-------------|
| <a name="output_this"></a> [this](#output\_this) | The prometheus docker service. |
<!-- END_TF_DOCS -->
