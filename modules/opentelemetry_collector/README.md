...
| Name | Source | Version |
|------|--------|---------|
| <a name="module_opentelemetry_docker_service"></a> [opentelemetry\_docker\_service](#module\_opentelemetry\_docker\_service) | github.com/ehwplus/terraswarm//modules/base_docker_service | main |
...
| <a name="input_custom_image"></a> [custom\_image](#input\_custom\_image) | The docker image name excluding the image tag | `string` | n/a | yes |
...
| <a name="input_opentelemetry_config"></a> [opentelemetry\_config](#input\_opentelemetry\_config) | The static config file for OpenTelemtry Collector | `string` | `null` | no |
| <a name="input_opentelemetry_service_port"></a> [opentelemetry\_service\_port](#input\_opentelemetry\_service\_port) | The internal and external service port for OpenTelemetry receiver | `number` | `4317` | no |
...
| Name | Description |
|------|-------------|
| <a name="output_this"></a> [this](#output\_this) | The Opentelemetry docker service. |
<!-- END_TF_DOCS -->
